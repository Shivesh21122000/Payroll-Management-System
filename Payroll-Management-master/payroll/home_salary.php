          ...
          <div class="well bs-component">
            <form class="form-horizontal">
              <fieldset>
                ...
                <p class="pull-right">Overtime rate per hour: <b><?php echo $rate; ?>.00</b></p><br>
                <p class="pull-right">Salary rate: <b><?php echo $salary; ?>.00</b></p>
                <p align="center" style="font: size 2em;"><b>Account</b></p>
                    ...
                    <table class="table table-bordered table-hover table-condensed" id="myTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td align="center"><b><?php echo $deduction?></b><b>.00</b></td>
                          <td align="center"><b><?php echo $overtime?></b> hrs</td>
                          <td align="center"><b><?php echo $bonus?></b><b>.00</b></td>
                          <td align="center"><b><?php echo $netpay?></b><b>.00</b></td>
                        </tr>
                        <?php } ?>
                      </tbody>
                    </table>
